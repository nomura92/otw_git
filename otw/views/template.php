                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown dropdown-fw dropdown-fw-disabled">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-fw">
                                        <li>
                                            <a href="#!menu=sistem.level"> Jenis Level</a>
                                        </li>
                                        <li>
                                            <a href="#!menu=sistem.bank"> Bank</a>
                                        </li>
                                        <li>
                                            <a href="#!menu=sistem.ktg.toko"> Kategori Toko</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown dropdown-fw dropdown-fw-disabled">
                                    <a href="javascript:;" class="text-uppercase"><i class="icon-briefcase"></i> Toko </a>
                                    <ul class="dropdown-menu dropdown-menu-fw">
                                        <li>
                                            <a href="#!menu=toko.list"> List Toko</a>
                                        </li>
                                        <li>
                                            <a href="#!menu=toko.pengisian.saldo">Pengisian Saldo</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown dropdown-fw dropdown-fw-disabled">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-fw">
                                        <li>
                                            <a href="#!menu=laporan.toko"> Laporan Toko</a>
                                        </li>
                                        <li>
                                            <a href="#!menu=laporan.perpanjangan"> Laporan Perpanjangan</a>
                                        </li>
                                        <li>
                                            <a href="#!menu=laporan.pengisian.saldo"> Laporan Pengisian Saldo</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown dropdown-fw dropdown-fw-disabled  ">
                                ...
                                <li class="dropdown dropdown-fw dropdown-fw-disabled  ">
                                    <a href="#!menu=toko.baru" class="text-uppercase"><i class="icon-plus"></i>Toko Baru </a>
                                </li>
                            </ul>
                        </div>
                        <!-- END HEADER MENU -->
...
<![endif]-->
        ...
        <!-- BEGIN CORE SYSTEM -->
        <script type="text/javascript" src="assets/js/sistem.level.js"></script>
        <script type="text/javascript" src="assets/js/sistem.bank.js"></script>
        <script type="text/javascript" src="assets/js/sistem.ktg.toko.js"></script>
        <script type="text/javascript" src="assets/js/toko.baru.js"></script>
        <script type="text/javascript" src="assets/js/toko.list.js"></script>
        <script type="text/javascript" src="assets/js/toko.pengisian.saldo.js"></script>
        <script type="text/javascript" src="assets/js/laporan.toko.js"></script>
        <!-- END CORE SYSTEM -->
    </body>
