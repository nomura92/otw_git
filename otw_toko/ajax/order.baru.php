...
$ms = new internal;
$sqlOrderBaru = "select * from otw_order where id_toko='$_SESSION[id_toko]' and proses=0 order by tgl_order desc";
	...
	foreach ($orderBaru as $baris) {
		$btnGroup = "<div class='btn-group'>
                            ...
                            <ul class='dropdown-menu' role='menu'>
                                ...
                                <li>
                                    <a href='javascript:;' class='prosesOrder' data-id='$baris->id_order'><i class='fa fa-spinner'></i> Proses </a>
                                </li>
                                <li>
