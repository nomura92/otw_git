...
//untuk blokir toko
$(document).on('click','.blokirToko',function(e){
    var id = $(this).data('id');
    var blokir = $(this).data('blokir');
    var bText = "";
    e.stopPropagation();
    if(blokir>0){
      bText = "Blokir akan dibuka";
      cText = "Ya, Buka blokir!";
    }else{
      bText = "Toko akan di blokir";
      cText = "Ya, Blokir toko!";
    }
    swal({
      title: "Apa kamu yakin?",
      text: bText,
